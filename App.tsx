...
const interstitial = InterstitialAd.createForAdRequest('ca-app-pub-6968109228755506/7084292830', {
  requestNonPersonalizedAdsOnly: true
});

const rewardedInterstitial = RewardedInterstitialAd.createForAdRequest('ca-app-pub-6968109228755506/7589859174', {
  requestNonPersonalizedAdsOnly: true
});

export default function App() {
  const [diceNumbers, setDiceNumbers] = useState([1, 1, 1, 1, 1]);
